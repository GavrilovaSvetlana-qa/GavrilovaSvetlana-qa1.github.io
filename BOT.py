...
bot = TeleBot(token='6933475135:AAHASmrpzeNSf2pvY6NzVvU9hbyvMJbl7vU', parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    ...
    if definition is None:
        ...
        bot.send_message(
            ...
            text='😋Ой, Я пока не знаю такого определения',
        )
        # выходим из функции
        return
